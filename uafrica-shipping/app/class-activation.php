...
class Activation {
	...
	public static function create_page() {
		...
		if ( ! empty( $option['shipping_page'] ) ) {
			// There already  appears to be an older shipping page form a previous activation.
			// No need to create a new shipping page.
			$option['activate_message']  = __( 'A shippings page was already found from a previous activation.', 'uafrica-shipping' ) . PHP_EOL;
		...
		// If the gutenberg block should be uses or not.
