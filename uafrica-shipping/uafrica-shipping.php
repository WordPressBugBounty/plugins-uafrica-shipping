<?php
/**
 * Plugin Name:       Bob Go smart shipping solution
...
define( 'UAFRICA_SHIPPING_VERSION', '2.5.22' );
...
add_filter( 'plugin_action_links_uafrica-shipping/uafrica-shipping.php', array( '\uAfrica_Shipping\app\Admin', 'add_plugin_page_settings_link' ) );
...
add_action( 'woocommerce_cart_shipping_packages', [ '\uAfrica_Shipping\app\WooCommerce', 'modify_shipping_packages' ], 20, 1 );
// Order
...
add_action( 'before_woocommerce_init', function () {
	if ( class_exists( '\Automattic\WooCommerce\Utilities\FeaturesUtil' ) ) {
		...
		\Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'cart_checkout_blocks', __FILE__, false ); // Blocks
	}
} );
